    ...
    <div class="mb-36 relative ">
        ...
        <div
            ...
            <div class="col-span-3   lg:col-span-2 rounded-b-xl relative h-full  flex items-center">
                <div class="w-full flex items-end h-3/4 md:h-full mt-20 lg:mt-0">
                ...
                <Transition>
                    <h3 v-if="activeIndex == 0" class="absolute hidden bottom-6 -left-2/3">
                        <div>{{ t('banner.german_tools') }} </div>
                        <div>{{ t('banner.profy_cleaner') }}</div>
                    </h3>

                    <h3 v-else class="absolute bottom-6 hidden -left-2/3">
                ...
                <Transition>
                    <h3 v-if="activeIndex == 0" class="absolute bottom-6  hidden     -right-2/3">
                        <div>{{ t('banner.cleaning_all') }}</div>
                        <div>{{ t('banner.price') }}</div>
                    </h3>

                    <h3 v-else class="absolute bottom-6   hidden         -right-2/3">
        ...
        <div class="container md:flex justify-between translate-y-24">
            <div class="servise-card">
                <div class="servise__icon  lg:absolute lg:-translate-y-1/2">
...
.servise__icon {
    ...
    background: radial-gradient(circle, rgba(174, 210, 135, 1) 0%, rgba(151, 199, 98, 1) 100%);
}
...
.gradient {
    ...
    background-image: linear-gradient(315deg, #addfad 0%, #AED287 74%);
}

.content {
    font-family: "Morice Bejar", sans - serif !important;
}
