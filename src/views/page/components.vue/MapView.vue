        ...
        <div class="flex justify-between items-center my-6">
            ...
            <div class="flex gap-8 items-center text-sm">
                <p class="flex items-center gap-2">
                    <svg class="text-maingreen" xmlns="http://www.w3.org/2000/svg" width="1rem" height="1.8rem"
                        viewBox="0 0 24 24">
                ...
                <button @click="scrollTo('order_form')" class="btn btn-ghost text-maingreen text-shadow-md">{{
                    $t('order') }}</button>
            </div>
        </div>
    </section>
